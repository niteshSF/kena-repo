...
const ButtonsPanel = () => {
  const {khanda_no, sutra_no, incrementSutra, decrementSutra, section } = useSutraStore()
  ...
  const { data } = useGetAudioQuery(section, khanda_no, sutra_no, mode)
  ...
  useEffect(() => {
    ...
    playAudio()
  }, [section, khanda_no, sutra_no, data])
